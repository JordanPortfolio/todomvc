			...
			<section class="main" *If="todoStore.todos.length > 0">
				...
				<ul class="todo-list">
					<li *for="#todo of todoStore.todos" [class.completed]="todo.completed" [class.editing]="todo.editing">
						...
						<input class="edit" *If="todo.editing" [value]="todo.title" #editedtodo (blur)="stopEditing(todo, editedtodo)" (keyup.enter)="updateEditingTodo(editedtodo, todo)" (keyup.escape)="cancelEditingTodo(todo)">
					</li>
				</ul>
			</section>
